    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('For children and parents', 'Детям и родителям'), ('Sports literature', 'Спортивная литература'), ('Business literature', 'Бизнес литература'), ('Scientific literature', 'Научная литература'), ('Children literature', 'Детская литература'), ('Biographies', 'Биографии'), ('Self-development', 'Саморазвитие'), ('History', 'История'), ('Health', 'Здоровье'), ('Finance', 'Финансы')], default='For children and parents', max_length=100, verbose_name='Жанр')),
                ...
                ('image_cover', models.ImageField(default='no_cover.jpeg', upload_to='book/static/book/images/', verbose_name='Обложка')),
